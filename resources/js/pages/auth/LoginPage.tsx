            ...
            <AuthLayoutTemplate title={`Login`} subTitle={'Inicia sesión'}>
                ...
                <div className="flex flex-col space-y-2">
                    ...
                    <div className="relative mb-4 flex items-center py-2">
                        ...
                        <span className="mx-4 flex-shrink text-[12px] leading-tight font-normal text-gray-500 uppercase">
                    ...
                    <div className="p-3 text-center">
                        <p className="text-[12px] leading-tight font-normal text-gray-500 uppercase">
