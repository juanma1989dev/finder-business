                                                            ...
                                                            <div className="flex flex-1 flex-col">
                                                                ...
                                                                <div className="mt-auto w-full pt-4">
                                                                    ...
                                                                    <div className="flex w-full items-center justify-between rounded-lg border border-green-600 bg-green-50 px-3 py-2">
                                                                        {/* Stepper */}
                                                                        <button className="flex h-7 w-7 items-center justify-center rounded-full bg-white text-green-600 shadow active:scale-95">
                                                                            −
                                                                        </button>

                                                                        {/* Confirmación */}
                                                                        <span className="flex animate-pulse items-center gap-1 text-sm font-semibold text-green-700">
                                                                            ✓
                                                                            Agregado
                                                                            (2)
                                                                        </span>
